...
/**
 * Starts background quote polling for the whole tab session.
 * Portfolio data is loaded lazily by each screen that needs it.
 */
      ...
      >
        ...
        <Tabs.Screen
          ...
          options={{
            title: t.nav.ai,
            tabBarIcon: ({ color, size }) => (
              <Brain size={size} color={color} strokeWidth={1.8} />
            ),
          }}
        />
        <Tabs.Screen
