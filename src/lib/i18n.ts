...
const en: Translations = {
  ...
  aiTerminal: {
    ...
    you: "YOU",
    quantai: "QUANTAI",
    setupHint: "Add your Gemini API key to enable AI analysis",
    setupStep1: "1. Get a free key at aistudio.google.com → API Keys",
    setupStep2: "2. Add AI_API_KEY=your_key to .env.local",
    setupStep3: "3. Restart the dev server — AI will connect automatically",
    bullish: "BULL",
    bearish: "BEAR",
    neutral: "NEUT",
  },
...
const zh: Translations = {
  ...
  aiTerminal: {
    ...
    you: "您",
    quantai: "QUANTAI",
    setupHint: "添加 Gemini API Key 以启用 AI 分析",
    setupStep1: "1. 在 aistudio.google.com → API Keys 获取免费密钥",
    setupStep2: "2. 在 .env.local 中添加 AI_API_KEY=your_key",
