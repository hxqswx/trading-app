...
const en: Translations = {
  ...
  aiTerminal: {
    ...
    you: "YOU",
    quantai: "QUANTAI",
    setupHint: "Add your Groq API key to enable AI analysis",
    setupStep1: "1. Get a free key at console.groq.com → API Keys",
...
const zh: Translations = {
  ...
  aiTerminal: {
    ...
    you: "您",
    quantai: "QUANTAI",
    setupHint: "添加 Groq API Key 以启用 AI 分析",
    setupStep1: "1. 在 console.groq.com → API Keys 获取免费密钥",
